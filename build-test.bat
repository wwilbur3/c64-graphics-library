...
REM Path to VICE c64 emulator executable
...
REM Some compilers can't handle a space in the COMPILER_BASE_PATH
...
if "%build_kickc%"=="y" (
    ...
    cd /D %KICKC_PATH%
    echo kickc.bat %KICKC_OPTS% -o %BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    call kickc.bat %KICKC_OPTS% -o %BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    cd /D %BASEPATH%
...
if "%build_vbcc%"=="y" (
    ...
    cd /D %VBCC_PATH%
    copy ..\config\c64 .
    echo vc.exe %VBCC_OPTS% -o %BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    vc.exe %VBCC_OPTS% -o %BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    del c64
    cd /D %BASEPATH%
    IF EXIST %BUILD_NAME%.prg %VICEBIN%\x64sc.exe %VICEOPTS% %BUILD_NAME%.prg
)
...
if "%build_cc65%"=="y" (
    ...
    IF EXIST %BUILD_NAME%.prg del /F /Q %BUILD_NAME%.prg
    cd /D %CC65_PATH%
    echo cl65.exe %CC65_OPTS% -o %BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    cl65.exe %CC65_OPTS% -o %BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    cd /D %BASEPATH%
    IF EXIST %BUILD_NAME%.prg %VICEBIN%\x64sc.exe %VICEOPTS% %BUILD_NAME%.prg
)
...
if "%build_sdcc%"=="y" (
    ...
    echo sdcc.exe %SDCC_OPTIONS% %SDCC_OPTIMIZE% %BASEPATH%\graphics-test.c
    sdcc.exe %SDCC_OPTIONS% %SDCC_OPTIMIZE% %BASEPATH%\graphics-test.c
    echo sdcc.exe -mmos6502 c64-graphics.rel graphics-test.rel -o %BUILD_NAME%.ihx
    sdcc.exe -mmos6502 c64-graphics.rel graphics-test.rel -o %BUILD_NAME%.ihx
...
if "%build_oscar64%"=="y" (
    ...
    IF EXIST %BUILD_NAME%.prg del /F /Q %BUILD_NAME%.prg
    cd /D %OSCAR64_PATH%
    echo oscar64.exe %OSCAR64_OPTIONS% -o=%BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    oscar64.exe %OSCAR64_OPTIONS% -o=%BASEPATH%\%BUILD_NAME%.prg %BASEPATH%\c64-graphics.c %BASEPATH%\c64-util.c %BASEPATH%\graphics-test.c
    cd /D %BASEPATH%
    IF EXIST %BUILD_NAME%.prg %VICEBIN%\x64sc.exe %VICEOPTS% %BUILD_NAME%.prg
)
